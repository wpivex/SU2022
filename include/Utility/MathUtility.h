...
float distancePointLine(float pointX, float pointY, float lineX1, float lineY1, float lineX2, float lineY2) {
...
float isPointTouchingLineSegment(float pointX, float pointY, float lineX1, float lineY1, float lineX2, float lineY2, float tolerance) {
...
Point getPointOnLineClosestToPoint(float pointX, float pointY, float lineX1, float lineY1, float lineX2, float lineY2) {
