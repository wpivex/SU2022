...
Robot18::Robot18() : BaseRobot(9.5, PORT16), 
...
void Robot18::setControllerMapping() {

}

float Robot18::distanceToDegrees(float distInches) {
  return distInches * (5/3.0) * 360 / 2 / M_PI / (3.25 / 2); // 4 in diameter wheels
}

float Robot18::degreesToDistance(float distDegrees) {
...
// return in inches
float Robot18::getLeftEncoderDistance() {
...
void Robot18::goForwardU(float distInches, float maxSpeed, float universalAngle, bool stopAfter, float startSpeed, float stopSpeed, float timeout) {
...
// Calling general function with 15-specifc params
void Robot18::goTurnU(float universalAngleDegrees, int direction, bool stopAfter, float timeout, float maxSpeed) {
  BaseRobot::goTurnU_Abstract(2.5, 0, 0.1, 1.3, 3, 18, universalAngleDegrees, direction, stopAfter, timeout, maxSpeed);
}

void Robot18::setLeftVelocity(directionType d, double percent) {
...
void Robot18::setRightVelocity(directionType d, double percent) {
...
void Robot18::setBrakeType(brakeType b) {
